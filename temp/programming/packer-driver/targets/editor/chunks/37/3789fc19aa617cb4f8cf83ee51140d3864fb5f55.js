    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = (_class3 = class GameController extends Component {
        ...
        createHomeUI() {
          ...
          const positions = [new Vec3(-100, 100, 0), new Vec3(100, 100, 0), new Vec3(-100, -80, 0), new Vec3(100, -80, 0)];
        ...
        startGame(gameId) {
          ...
          tween(this.homeRoot).to(0.3, {
            ...
            switch (gameId) {
              case 'match3':
                const match3 = gameNode.addComponent(_crd && Match3Game === void 0 ? (_reportPossibleCrUseOfMatch3Game({
                  error: Error()
              ...
              case 'snake':
                const snake = gameNode.addComponent(_crd && SnakeGame === void 0 ? (_reportPossibleCrUseOfSnakeGame({
                  error: Error()
                }), SnakeGame) : SnakeGame);
              ...
              case '2048':
                const g2048 = gameNode.addComponent(_crd && Game2048 === void 0 ? (_reportPossibleCrUseOfGame({
                  error: Error()
                }), Game2048) : Game2048);
              ...
              case 'tetris':
                const tetris = gameNode.addComponent(_crd && TetrisGame === void 0 ? (_reportPossibleCrUseOfTetrisGame({
                  error: Error()
