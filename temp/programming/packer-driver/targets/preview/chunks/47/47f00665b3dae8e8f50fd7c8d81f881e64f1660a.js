    ...
    execute: function () {
      ...
      _export("ParticleManager", ParticleManager = (_dec = ccclass('ParticleManager'), _dec(_class = (_class2 = class ParticleManager extends Component {
        ...
        showScoreFloat(score, pos, parent) {
          var label = new Node('ScoreFloat');
          label.parent = parent;
          label.position = pos;
          var lbl = label.addComponent(require('cc').Label);
          lbl.string = '+' + score;
          lbl.fontSize = 32;
        ...
        playExplosion(pos, parent) {
          var node = new Node('Explosion');
          node.parent = parent;
          node.position = pos;
          var sprite = node.addComponent(require('cc').Sprite);
          sprite.color = new require('cc').Color(255, 200, 100);
          var transform = node.addComponent(require('cc').UITransform);
          transform.width = 50;
          transform.height = 50;
          tween(node).to(0.3, {
