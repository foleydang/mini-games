  ...
  return {
    ...
    execute: function () {
      ...
      _export("StorageManager", StorageManager = class StorageManager {
        ...
        static getUserData() {
          try {
            var data = sys.localStorage.getItem(this.USER_DATA_KEY);
        ...
        static getLevelProgress(gameId) {
          try {
            var data = sys.localStorage.getItem(this.LEVEL_DATA_KEY + gameId);
        ...
        static doSignIn() {
          ...
          var newSignDays = userData.lastSign === yesterday ? userData.signDays + 1 : 1;
          ...
          var reward = rewards[newSignDays - 1];
        ...
        static updateHighScore(gameId, score) {
          var userData = this.getUserData();
          var progress = this.getLevelProgress(gameId);
