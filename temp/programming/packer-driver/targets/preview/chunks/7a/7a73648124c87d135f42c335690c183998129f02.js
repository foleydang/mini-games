    ...
    execute: function () {
      ...
      _export("PauseMenu", PauseMenu = (_dec = ccclass('PauseMenu'), _dec(_class = class PauseMenu extends Component {
        ...
        createButton(text, color) {
          var btn = new Node('Button'); // 背景

          var sprite = btn.addComponent(Sprite);
          sprite.color = color;
          var transform = btn.addComponent(UITransform);
          transform.width = 200;
          transform.height = 50; // 文字

          var label = this.createLabel(text, 20, Color.WHITE, true);
